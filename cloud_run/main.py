...
app = FastAPI(title="Gemini Web Chatbot (Cloud Run)", version="2.0.0")
...
async def health_check():
    return {"status": "healthy", "service": "gemini-chatbot-cloud-run"}
...
if os.path.exists(static_dir):
    ...
    async def index_fallback():
        return {
            "message": "Gemini 챗봇 Cloud Run 서버가 동작 중입니다. frontend를 빌드하여 static 폴더를 생성해주세요."
        }
